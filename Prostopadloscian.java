...
public class Prostopadloscian extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    float krotszy, dluzszy, wysokosc;
    ...
    public void oblicz2(View view) {
        ...
        wysokosc = Float.parseFloat(editText.getText().toString());
        TextView poleCalk = (TextView)findViewById(R.id.textView4);
        poleCalk.setText(2*krotszy*dluzszy + 2*krotszy*wysokosc + 2*dluzszy*wysokosc + "cm");
        TextView objetosc = (TextView)findViewById(R.id.textView6);
        objetosc.setText(krotszy*dluzszy*wysokosc + "cm");
