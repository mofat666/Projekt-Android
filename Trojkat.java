...
public class Trojkat extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void oblicz(View view) {
        ...
        podstawa = Float.parseFloat(editText2.getText().toString());
        TextView pole = (TextView)findViewById(R.id.textView4);
        pole.setText((wysokosc*podstawa)/2 + "cm");
